...
async  fn main(){
    let user = User {
        name: "Arnav Sharma".to_string(),
        age: 22,
        email: "mail@arnavsharma.com.np".to_string()
    };

    let firebase = Firebase::new("https://rust-firebase-url.firebaseio.com/").unwrap();
    ...
    user.email = "updated@mail.com".to_string();
